...
if(
    ...
    if (!array_key_exists($_POST['type'], $sellOrRents)){
        $errors[] = 'Veulliez choisir si c\'est une vente ou une location!';
    }

    if (mb_strlen($_POST['description']) < 5 || mb_strlen($_POST['description']) > 20000){
        $errors[] = 'Le commentaire doit être compris en 5 à 20000 caractères !';
    }
    ...
    if(!isset($errors)){
        ...
        $insertPlace = $bdd->prepare('INSERT INTO logements(titre, adresse, ville, code_postale, surface, prix, photo, type, description) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?,)');

        $statut = $insertPlace->execute([
            $_POST['titre'],
            $_POST['adresse'],
            $_POST['ville'],
            $_POST['code_postale'],
        ...
        if($statut){
            ...
            $errors[] = " il y a eu un problème lors de l'ajout du logement', veuillez réessayer plus tard";
            }
        }
    }
?>
                    ...
                    <div class="col-12 col-md-8 offset-md-2 py-5">
                        ...
                        ?>
                            <div class="mb-3">
                                ...
                                <input placeholder="Titre" id="titre" type="text" name="titre" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="adresse" class="form-label">Adresse</label>
                                <input placeholder="Adresse" id="adresse" type="text" name="adresse" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="ville" class="form-label">Ville</label>
                                <input placeholder="Ville" id="ville" type="ville" name="name" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="code_postal" class="form-label">Code postal</label>
                                <input placeholder="Code postal" id="code_postal" type="text" name="code_postal" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="surface" class="form-label">Surface</label>
                                <input placeholder="Surface" id="surface" type="text" name="surface" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="prix" class="form-label">Prix</label>
                                <input placeholder="Prix" id="prix" type="text" name="prix" class="form-control">
                            </div>
                            <div class="mb-3">
